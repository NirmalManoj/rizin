...
RZ_IPI RzCmdStatus rz_meta_format_handler(RzCore *core, int argc, const char **argv, RzCmdStateOutput *state);
...
RZ_IPI RzCmdStatus rz_meta_hiddden_handler(RzCore *core, int argc, const char **argv, RzCmdStateOutput *state);
...
RZ_IPI RzCmdStatus rz_meta_magic_handler(RzCore *core, int argc, const char **argv, RzCmdStateOutput *state);
...
RZ_IPI RzCmdStatus rz_meta_run_handler(RzCore *core, int argc, const char **argv, RzCmdStateOutput *state);
...
RZ_IPI RzCmdStatus rz_meta_type_handler(RzCore *core, int argc, const char **argv, RzCmdStateOutput *state);
...
RZ_IPI RzCmdStatus rz_meta_string_zero_handler(RzCore *core, int argc, const char **argv);
