...
static const RzCmdDescArg comment_add_at_args[3];
...
static const RzCmdDescArg meta_hiddden_args[2];
...
static const RzCmdDescArg meta_string_remove_args[2];
...
static const RzCmdDescHelp comment_help = {
	.summary = "Append comment / List all comments",
	.args = comment_args,
};
...
static const RzCmdDescArg comment_add_at_args[] = {
	{
		.name = "address",
		.type = RZ_CMD_ARG_TYPE_RZNUM,
...
static const RzCmdDescHelp comment_add_at_help = {
	.summary = "Add comment at the specified address",
	.args = comment_add_at_args,
};
...
static const RzCmdDescHelp meta_space_help = {
	.summary = "Create new metaspace / List all metaspaces",
...
static const RzCmdDescHelp meta_format_help = {
	.summary = "Set the format string to the current address / List all format marks",
...
static const RzCmdDescHelp meta_data_help = {
	.summary = "Set the \"data\" mark to the current address / List all \"data\" marks",
	.args = meta_data_args,
};
...
static const RzCmdDescArg meta_hiddden_args[] = {
	{
		.name = "size",
		.type = RZ_CMD_ARG_TYPE_RZNUM,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp meta_hiddden_help = {
	.summary = "Set the \"hidden\" mark to the current address / List all \"hidden\" marks",
	.args = meta_hiddden_args,
};
...
static const RzCmdDescHelp meta_magic_help = {
	.summary = "Set the magic to the current address / List all magic marks",
...
static const RzCmdDescHelp Cr_help = {
	.summary = "Manage the \"mun\" mark metainformation",
};
...
static const RzCmdDescHelp meta_string_help = {
	.summary = "Add string / List all strings",
...
static const RzCmdDescHelp meta_type_help = {
	.summary = "Set the type comment to the current address / List all type comments",
	.args = meta_type_args,
};
...
static const RzCmdDescArg meta_string_zero_args[] = {
	{ 0 },
};
static const RzCmdDescHelp meta_string_zero_help = {
	.summary = "Add zero-terminated string",
	.args = meta_string_zero_args,
};
...
RZ_IPI void rzshell_cmddescs_init(RzCore *core) {
	...
	RzCmdDesc *CC_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "CC", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_LONG, rz_comment_handler, &comment_help, &CC_help);
	...
	RzCmdDesc *comment_filelink_cd = rz_cmd_desc_argv_new(core->rcmd, CC_cd, "CC,", rz_comment_filelink_handler, &comment_filelink_help);
	rz_warn_if_fail(comment_filelink_cd);

	RzCmdDesc *comment_add_at_cd = rz_cmd_desc_argv_new(core->rcmd, CC_cd, "CCa", rz_comment_add_at_handler, &comment_add_at_help);
	rz_warn_if_fail(comment_add_at_cd);
	...
	RzCmdDesc *CS_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "CS", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON, rz_meta_space_handler, &meta_space_help, &CS_help);
	...
	RzCmdDesc *Cf_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "Cf", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON, rz_meta_format_handler, &meta_format_help, &Cf_help);
	...
	RzCmdDesc *Cd_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "Cd", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON, rz_meta_data_handler, &meta_data_help, &Cd_help);
	...
	RzCmdDesc *Ch_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "Ch", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON, rz_meta_hiddden_handler, &meta_hiddden_help, &Ch_help);
	...
	RzCmdDesc *Cm_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "Cm", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON, rz_meta_magic_handler, &meta_magic_help, &Cm_help);
	...
	RzCmdDesc *Cr_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "Cr", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON, rz_meta_run_handler, &meta_run_help, &Cr_help);
	...
	RzCmdDesc *Cs_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "Cs", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON | RZ_OUTPUT_MODE_LONG, rz_meta_string_handler, &meta_string_help, &Cs_help);
	rz_warn_if_fail(Cs_cd);
	...
	RzCmdDesc *Ct_cd = rz_cmd_desc_group_state_new(core->rcmd, C_cd, "Ct", RZ_OUTPUT_MODE_STANDARD | RZ_OUTPUT_MODE_RIZIN | RZ_OUTPUT_MODE_JSON, rz_meta_type_handler, &meta_type_help, &Ct_help);
	...
	RzCmdDesc *meta_string_zero_cd = rz_cmd_desc_argv_new(core->rcmd, C_cd, "Cz", rz_meta_string_zero_handler, &meta_string_zero_help);
	rz_warn_if_fail(meta_string_zero_cd);
